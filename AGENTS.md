...
An agent working in this repo should read
[`docs/conventions.md`](docs/conventions.md) first: it holds the hard rules
(Colima/SQLite, hardlink layout, VPN namespace, no public exposure) and the
conventions for changes, jobs, and secrets.
